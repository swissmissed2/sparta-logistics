...
|-----|:------:|:-----------:|:----------------:|:---------------:|
| 배송 단건 조회 | ✅ 전체 | ✅ 자기 허브 소속 | ✅ 자신 담당 배송² | ✅ 자기 업체 배송¹ |
| 배송 목록 조회 | ✅ 전체 | ✅ 자기 허브 필터 | ✅ 자신 담당 필터² | ✅ 자기 업체 필터¹ |
| 배송 수정 | ✅ | ✅ 자기 허브 소속 | ❌ | ❌ |
| 배송 상태 변경 | ✅ | ✅ 자기 허브 소속 | ✅ 자신 담당 배송² | ❌ |
| 배송 삭제 | ✅ | ❌ | ❌ | ❌ |

> ¹ COMPANY_MANAGER는 order-service Feign 호출로 companyId 소속 orderId 목록을 조회하여 해당 배송만 접근 허용.  
> 단건 조회: `DeliveryPermissionChecker` → `order-service GET /orders/{orderId}/company-check`  
> 목록 조회: `order-service GET /orders/by-company?companyId=` 로 orderId 목록 취득 후 IN 필터 적용.
>
