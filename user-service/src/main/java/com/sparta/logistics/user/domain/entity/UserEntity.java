package com.sparta.logistics.user.domain.entity;

import com.sparta.logistics.common.domain.BaseEntity;
import com.sparta.logistics.user.domain.enums.UserRole;
import com.sparta.logistics.user.domain.enums.UserStatus;
